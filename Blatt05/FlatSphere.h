...
{
public:
	FlatSphere(cg::GLSLProgram & prog, double radius, unsigned int stacks, unsigned int slices, bool lighting);
	FlatSphere(cg::GLSLProgram & prog, double radius, bool lighting);
	FlatSphere(cg::GLSLProgram & prog, bool lighting);
	FlatSphere(cg::GLSLProgram & prog);
	~FlatSphere();
